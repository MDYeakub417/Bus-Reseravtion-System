...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"SHYAMOLI *H.K*","SHYAMOLI *A.K*","SHYAMOLI *M.Y.K*","SHYAMOLI *P.P.M*","SHYAMOLI *A.D*","SHYAMOLI *K.A.Y.P,A*"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
void login()
{
  int a=0,i=0;
    ...
    char user[10]="FiveStar";
    char pass[10]="FiveStar";
    do
{
  system("cls");
  ...
  i=0;
  //scanf("%s",&pword);
    if(strcmp(uname,"FiveStar")==0 && strcmp(pword,"FiveStar")==0)
  {
  printf("  \n\n\n\t\t\t\t***WELCOME***\n\n\t\t\t     LOGIN IS SUCCESSFUL");
  printf("\n\n\n\tPlease Press Enter ");
